...
export class PentadbirService {
  constructor(
    ...
    @InjectModel(TemplateRubric.name)
    private readonly templateModel: Model<TemplateRubric>,
  ) {}
  ...
  async getCerapanOverview() {
    return { totalCerapan: 0, completed: 0, pending: 0 };
  }

  async getAllTemplates(): Promise<TemplateRubric[]> {
    return this.templateModel.find().sort({ updatedAt: -1 });
  }
  ...
  async ensureDefaultTapakTemplate(): Promise<void> {
    ...
    const pattern4 = [
      {
        score: 4,
        label: 'Cemerlang',
        description: 'Memenuhi semua empat (4) kriteria yang ditetapkan',
      },
      {
        score: 3,
        label: 'Baik',
    ...
    const patternObj = [
      ...
      },
      {
        ...
        label: 'Baik',
        description:
          'Mengambil kira perkara (i) dan (ii) atau perkara (i) dan (iii)',
      },
      {
        score: 2,
        label: 'Sederhana',
    ...
    const patternPerc50 = [
      {
        ...
        label: 'Cemerlang',
        description:
          'i. Pelibatan 50%-100% murid\nii. Selaras dengan objektif pelajaran\iii. Dengan yakin\iv. Secara berhemah/bersungguh-sungguh',
      },
      {
        score: 3,
        label: 'Baik',
        description:
          'Memenuhi sekurang-kurangnya dua (2) perkara daripada (ii), (iii), (iv)',
      },
      {
        score: 2,
        label: 'Sederhana',
        description:
          'Memenuhi sekurang-kurangnya satu (1) perkara daripada (ii), (iii), (iv)',
      },
      {
        score: 1,
        label: 'Lemah',
        description: 'Tidak menunjukkan ciri-ciri perkara (ii), (iii), (iv)',
      },
      {
        score: 0,
        label: 'Tidak Memuaskan',
      ...
      categories: [
        {
          id: 'cat_41',
          code: '4.1',
          name: 'ASPEK 4.1: GURU SEBAGAI PERANCANG',
          description: 'Perancangan PdPc dan sokongan',
          subCategories: [
            {
              id: 'subcat_4_1_1',
              code: '4.1.1',
              name: 'Perancangan PdPc',
              description: 'Objektif, pentaksiran, bahan',
              items: [
                {
                  id: 'item_4_1_1_a',
                  text: 'Menyediakan RPH yang mengandungi objektif yang boleh diukur dan aktiviti pembelajaran yang sesuai',
                  maxScore: 4,
                  scoreDescriptions: patternObj,
                },
                {
                  id: 'item_4_1_1_b',
        ...
        },
        {
          id: 'cat_42',
          code: '4.2',
          name: 'ASPEK 4.2: GURU SEBAGAI PENGAWAL',
          description: 'Mengelola proses dan suasana PdPc',
          subCategories: [
            {
              id: 'subcat_4_2_1',
              code: '4.2.1',
              name: 'Mengelola proses pembelajaran',
              description: 'Isi pelajaran, masa dan penyertaan aktif',
              items: [
                {
                  id: 'item_4_2_1_a',
            ...
            },
            {
              id: 'subcat_4_2_2',
              code: '4.2.2',
              name: 'Mengelola suasana pembelajaran',
              description:
                'Komunikasi, perlakuan, kedudukan, aktiviti menyeronokkan',
              items: [
                {
                  id: 'item_4_2_2_a',
                  text: 'Mengawasi komunikasi murid dalam PdPc',
                  maxScore: 4,
                  scoreDescriptions: patternBerhemah,
                },
                {
                  id: 'item_4_2_2_b',
        ...
        },
        {
          id: 'cat_43',
          code: '4.3',
          name: 'ASPEK 4.3: GURU SEBAGAI PEMBIMBING',
          description: 'Bimbingan isi, kemahiran, sumber & integrasi',
          subCategories: [
            {
              id: 'subcat_4_3_1',
              code: '4.3.1',
              name: 'Bimbingan murid',
              description: 'Isi, kemahiran, keputusan, sumber, kaitan',
              items: [
                {
                  id: 'item_4_3_1_a',
                  text: 'Memberi tunjuk ajar/tunjuk cara/panduan menguasai isi pelajaran, konsep, atau fakta',
                  maxScore: 4,
                  scoreDescriptions: pattern4,
                },
                {
                  id: 'item_4_3_1_b',
                ...
                {
                  id: 'item_4_3_1_e',
                  text: 'Menggabung/merentas/mengaitkan isi pelajaran dengan tajuk/unit/tema/nilai/kemahiran/mata pelajaran lain',
                  maxScore: 4,
                  scoreDescriptions: pattern4,
                },
              ],
        ...
        },
        {
          id: 'cat_44',
          code: '4.4',
          name: 'ASPEK 4.4: GURU SEBAGAI PENDORONG',
          description:
            'Merangsang komunikasi, kolaboratif, soalan, kepimpinan & emosi',
          subCategories: [
            {
              id: 'subcat_4_4_1',
              code: '4.4.1',
              name: 'Mendorong minda & tindakan murid',
              description:
                'Komunikasi, kolaboratif, pemikiran, keputusan, kepimpinan, soalan, kendiri',
              items: [
                {
                  id: 'item_4_4_1_a',
                ...
                {
                  id: 'item_4_4_1_c',
                  text: 'Mengemukakan soalan yang menjurus ke arah pemikiran kritis dan kreatif',
                  maxScore: 4,
                  scoreDescriptions: patternObj,
                },
                {
                  id: 'item_4_4_1_d',
                  text: 'Mengajukan soalan/mewujudkan situasi yang menjurus ke arah membuat keputusan dan menyelesaikan masalah',
                  maxScore: 4,
                  scoreDescriptions: patternObj,
                },
                {
            ...
            },
            {
              id: 'subcat_4_4_2',
              code: '4.4.2',
              name: 'Mendorong emosi murid',
              description: 'Pujian, penghargaan, keyakinan, keprihatinan',
              items: [
                {
                  id: 'item_4_4_2_a',
        ...
        },
        {
          id: 'cat_45',
          code: '4.5',
          name: 'ASPEK 4.5: GURU SEBAGAI PENILAI',
          description: 'Pelaksanaan pelbagai kaedah pentaksiran dan refleksi',
          subCategories: [
            {
              id: 'subcat_4_5_1',
              code: '4.5.1',
              name: 'Pelaksanaan pentaksiran',
              description:
                'Pelbagai kaedah, pemulihan, latihan, refleksi, semakan',
              items: [
                {
                  id: 'item_4_5_1_a',
        ...
        },
        {
          id: 'cat_46',
          code: '4.6',
          name: 'ASPEK 4.6: MURID SEBAGAI PEMBELAJAR AKTIF',
          description:
            'Respons, komunikasi, kolaboratif, pemikiran, soalan, kaitan, keputusan',
          subCategories: [
            {
              id: 'subcat_4_6_1',
              code: '4.6.1',
              name: 'Penglibatan aktif murid',
              description: 'Pelibatan dan interaksi dalam PdPc',
              items: [
                {
                  id: 'item_4_6_1_a',
                  text: 'Memberi respons berkaitan isi pelajaran',
                  maxScore: 4,
                  scoreDescriptions: patternPerc90,
                },
                {
                  id: 'item_4_6_1_b',
                ...
                {
                  id: 'item_4_6_1_d',
                  text: 'Memberi respons ke arah pemikiran kritis dan kreatif',
                  maxScore: 4,
                  scoreDescriptions: patternPerc50,
                },
                {
                  id: 'item_4_6_1_e',
                ...
                {
                  id: 'item_4_6_1_f',
                  text: 'Mengaitkan isi pelajaran dengan kehidupan murid/isu lokal/global',
                  maxScore: 4,
                  scoreDescriptions: patternPerc50,
                },
                {
                  id: 'item_4_6_1_g',
                  text: 'Membuat keputusan dan menyelesaikan masalah berkaitan aktiviti pembelajaran',
                  maxScore: 4,
                  scoreDescriptions: patternPerc50,
                },
              ],
  ...
  async updateCategory(
    ...
    if (data.description !== undefined)
      template.categories[idx].description = data.description;
    template.updatedAt = new Date();
    return template.save();
  }
  ...
  async updateSubCategory(
    ...
    if (data.description !== undefined)
      category.subCategories[idx].description = data.description;
    template.updatedAt = new Date();
    return template.save();
  }
  ...
  async addItem(
    ...
    sub.items.push({
      ...
      scoreDescriptions: data.scoreDescriptions || [],
    } as any);
    template.updatedAt = new Date();
    return template.save();
  }
  ...
  async updateItem(
    ...
    if (data.scoreDescriptions !== undefined)
      sub.items[idx].scoreDescriptions = data.scoreDescriptions;
    template.updatedAt = new Date();
    return template.save();
  }
