...
import {
  TemplateRubric,
  TemplateRubricSchema,
} from './src/pentadbir/template.schema';
...
async function createDefaultTemplate() {
  try {
    ...
    const defaultTemplate = {
      ...
      description:
        'Template standard penilaian cerapan untuk guru berdasarkan Standard Kualiti Pendidikan Malaysia (SKPM) 2.0',
      scaleSkor: 4,
      categories: [
        {
          id: 'cat_41',
          ...
          description:
            'Guru merancang pengajaran dan pembelajaran dengan berkesan',
          subCategories: [
            {
              id: 'subcat_41a',
              code: '4.1.1',
              ...
              description:
                'Guru menyediakan RPH yang komprehensif dan berkesan',
              items: [
                {
                  id: 'item_41a1',
            ...
            },
            {
              ...
              description:
                'Guru menyesuaikan pengajaran mengikut keperluan murid',
              items: [
                {
                  id: 'item_41b1',
        ...
        },
        {
          ...
          description:
            'Guru memfasilitasi pengajaran dan pembelajaran dengan berkesan',
          subCategories: [
            {
              id: 'subcat_42a',
              code: '4.2.1',
              ...
              description:
                'Guru melaksanakan pengajaran mengikut rancangan yang ditetapkan',
              items: [
                {
                  id: 'item_42a1',
            ...
            },
            {
              ...
              description:
                'Guru menggunakan pelbagai kaedah pengajaran yang berkesan',
              items: [
                {
                  id: 'item_42b1',
          ...
          subCategories: [
            {
              ...
              description:
                'Guru menjalankan penilaian semasa proses pembelajaran',
              items: [
                {
                  id: 'item_43a1',
        ...
        },
        {
          ...
          subCategories: [
            ...
            },
            {
              ...
              description:
                'Guru melibatkan murid secara aktif dalam pembelajaran',
              items: [
                {
                  id: 'item_44b1',
        ...
        },
        {
          ...
          description:
            'Guru menunjukkan kepimpinan dalam pengurusan bilik darjah',
          subCategories: [
            {
              id: 'subcat_45a',
              code: '4.5.1',
          ...
          subCategories: [
            {
              ...
              description:
                'Guru menunjukkan sikap dan tingkah laku yang profesional',
              items: [
                {
                  id: 'item_46a1',
            ...
            },
            {
              ...
              description:
                'Guru terlibat dalam pembangunan profesional berterusan',
              items: [
                {
                  id: 'item_46b1',
